...
\CVItem{\href{https://srrg.gitlab.io/sashago.html}{Systematic Handling of Heterogeneous Geometric 
Primitives in Graph-SLAM Optimization}}{
\textbf{\small 2019 - RSS and RA-L} \\
In this work, we propose a pose-landmark graph optimization back-end
that supports maps consisting of points, lines or planes. Our
back-end allows representing both homogeneous (\emph{point-point},
\emph{line-line}, \emph{plane-plane}) and heterogeneous measurements
(\emph{point-on-line}, \emph{point-on-plane}, \emph{line-on-plane}).
Rather than treating all cases independently, we use a unified
formulation that leads to both a compact derivation and a concise
implementation. The additional geometric information, deriving from
the use of higher-dimension primitives and constraints, yields to
increased robustness and widens the convergence basin of our
method.}

\CVItem{\href{https://arxiv.org/abs/1809.00952}{Matrix Difference in Pose-Graph Optimization}}{
\textbf{\small 2018 - ArXiv} \\
